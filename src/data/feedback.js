export const reviews = [
  {
    ...
    rating: 4,
    content:
      "OMG! When my fingers first touched my duvet cover I couldn't believe how soft it was! I have other duvet covers but I know I'll never use them again. I have an AirB&B unit and I had to order another cover to use on the duvet for the bed in there as well. People already rave about the Cozy House sheets I have on the bed. I love the zipper instead of buttons. It saves time and gives a cleaner look. You will be delighted with this product! This is a completely unsolicited review.",
    user: "Rebecca E.",
    video: "",
  },
  {
